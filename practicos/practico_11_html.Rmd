...
> *a)* Tome como argumento a un nombre e imprima a pantalla un saludo. La funcion paste() le puede ser util.
...
> *d)* Dados dos vectores, uno con nombres y otro con números de teléfono, se devuelva un data.frame con los mismos. El mismo deberá indexar a dichas personas con números (ver ejemplo a continuación). 

```{r, echo = F, eval = T}
library(knitr)
nombres = c('Juan', 'Sofia', 'Mario', 'Veronica')
tel = c('22222222', '1111111', '4444444', '5555555')
knitr::kable(data.frame('Numero' = 1:length(nombres), 'Nombre' = nombres, 'Telefono' = tel))
...
Considere, ademas, que se realice la operacion si poseen igual largo los vectores. En caso de que esto no suceda, devuelva al usuario un mensaje con la funcion stop().
...
> **Nota:** si le ayuda, utilice el vector **letters** (que se encuentra por defecto en R), la funcion s2c() de la libreria seqinr y la funcion grep.
